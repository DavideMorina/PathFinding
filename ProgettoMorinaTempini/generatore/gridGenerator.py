...
def generaGriglia(nrows, ncols, freeCellRatio, agglomerationFactor):
    """Metodo per la generazione della griglia
    Parametri: nrows, ncols, freeCellRatio, agglomerationFactor
    Restituisce: griglia
    Genera l'oggetto griglia, calcoli alcuni parametri che la caratterizzano e passa quindi alla generazione degli ostacoli"""
...
def aggiungiOstacoli(griglia, numOstacoli, agglomerationFactor):
    """Metodo per la generazione degli ostacoli
    Parametri: griglia, numOstacoli, agglomerationFactor
    Restituisce: nessuno
    Dopo aver generato le agglomerazioni, posiziona nella griglia gli ostacoli rimanenti"""
...
def creaAgglomerazioni(griglia, numOstacoliAgglomerati):
    """Metodo per la generazione delle agglomerazioni
    Parametri: griglia, numOstacoliAgglomerati
    Restituisce: nessuno
    Dopo aver calcolato numero e dimensioni delle agglomerazioni, procede al generarle. Tutto in maniera casuale"""
    ...
    #print("Agglomerazioni", agglomerazioni)
